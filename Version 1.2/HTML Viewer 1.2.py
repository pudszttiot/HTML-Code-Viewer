...
class HTMLViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("WindowLogo.ico"))
...
<b><marquee width="100%" behavior="alternate">TTIOT - TTIOT - TTIOT</marquee></b>
        ...
        run_button = QPushButton(QIcon("run.png"), "Run Code")
        ...
        save_button = QPushButton(QIcon("save.png"), "Save Code")
        ...
        load_button = QPushButton(QIcon("open.png"), "Load HTML")
