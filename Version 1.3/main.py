...
<b><marquee width="100%" behavior="alternate">TTIOT - TTIOT - TTIOT</marquee></b>
    ...
    def show_how_to_use(self):
        ...
        how_to_use_dialog.setGeometry(150, 150, 600, 400)
        ...
        instructions_label.setText(
            "How to Use HTML Code Viewer:\n"
            "\n1. Enter your HTML code in the text area.\n"
            "2. Click the 'Run Code' button to display the HTML content.\n"
            "3. Click the 'Save Code' button to save the HTML code to a file.\n"
            "4. Click the 'Load HTML' button to open and edit an HTML file.\n"
            "5. Use the 'File' menu to exit the application.\n"
        )
